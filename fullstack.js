var data = {
  en: {
    ...
    btn2: "Resume",
    ainfo:"About",
    paragraph:"Hello! I'm Hari Charan, a passionate Computer Science and Engineering student currently pursuing my B.Tech, set to graduate in 2027. With a solid foundation from my diploma and a growing expertise in web development and Python programming, I am committed to leveraging technology to create innovative solutions.",
    ...
    disofproject1:"Input total classes and attended classes, calculate attendance percentage, and display results with simple formatting.",
  ...
  ja: {
    ...
    btn2: "再開する",
    ainfo:"について",
    paragraph:"こんにちは！私は Hari Charan です。コンピューター サイエンスとエンジニアリングに熱心に取り組んでいる学生で、現在は B.Tech を取得して 2027 年に卒業する予定です。学位で得た確固たる基礎と、Web 開発と Python プログラミングの専門知識を活かして、テクノロジーを活用して革新的なソリューションを生み出すことに尽力しています。",
    ...
    disofproject1:"総クラス数と出席クラス数を入力し、出席率を計算し、結果を簡単なフォーマットで表示します。",
    disofproject2:"血液型の検索、登録フォーム、ドナー資格ガイドラインを備えた、ドナーと受信者をつなぐプラットフォームです。"
  }
};
...
document.querySelector(".send-btn").addEventListener("click",(event)=>{
  ...
  if(info != "" && document.querySelector(".email-in").value.slice(-10) === "@gmail.com")
  {
      document.querySelector(".pop-box").style.display="none";
...
// const data = {
//   frontend:{title:'Front-End',skills:['Html','Css','Java Script','Bootstrap','React']},
//   backend:{title:'Back-End',skills:['Python','Flask','Sql','Rest API','Java(intermidiate)']},
//   uiux:{title:'UI-UX',skills:['Framer','Figma','others']},
//   tools:{title:'Tools',skills:['git','git hub','vercal','vite',]}
// };
